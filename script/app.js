...
document.addEventListener("DOMContentLoaded", () => {
  const lines = [
    ...
    "<span class='terminal-colour'>haydennaicker:~$</span>   → Data Analyst & BI Specialist",
    "<span class='terminal-colour'>haydennaicker:~$</span>   → Web Application Developer",
    "<span class='terminal-colour'>haydennaicker:~$</span>   → Microsoft Certified Trainer",
    "<span class='terminal-colour'>haydennaicker:~$</span>   → Multimedia Designer (UI/UX)",
    "<span class='terminal-colour'>haydennaicker:~$</span> ",
